<div
class="nav-bottom fixed bottom-0 left-0 w-full flex gap-4 items-center justify-end font-bold bg-laravel text-xl text-white h-36 mt-24" onmousedown="this.blur();return false;" onclick="this.blur();return false;">
